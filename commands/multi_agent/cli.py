...
def add_task(title, command, work_dir, directory, priority, complexity, timeout, description):
    ...
    command_obj.run(title=title, command=list(command), work_dir=work_dir, directory=directory, priority=priority, complexity=complexity, timeout=timeout, description=description)
...
def semantic_merge(source_file, target_file, language, strategy):
    ...
    command.run(source_file=source_file, target_file=target_file, language=language, strategy=strategy)
