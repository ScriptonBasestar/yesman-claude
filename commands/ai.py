...
from libs.ai.adaptive_response import AdaptiveResponse, AdaptiveConfig
...
def predict(prompt_text, context, project):
    ...
    try:
        ...
        prediction_text.append(f"Prompt: ", style="bold cyan")
        prediction_text.append(f"{prompt_text}\\n", style="white")
        
        if context:
            prediction_text.append(f"Context: ", style="bold yellow")
            prediction_text.append(f"{context}\\n", style="dim")
        
        if project:
            prediction_text.append(f"Project: ", style="bold blue")
            prediction_text.append(f"{project}\\n", style="dim")
        
        prediction_text.append(f"\\nPredicted Response: ", style="bold green")
        prediction_text.append(f"{predicted_response}\\n", style="green")
        
        prediction_text.append(f"Confidence: ", style="bold magenta")
        prediction_text.append(f"{confidence:.2%}\\n", style="magenta")
        
        prediction_text.append(f"Auto-respond: ", style="bold")
        if should_respond:
