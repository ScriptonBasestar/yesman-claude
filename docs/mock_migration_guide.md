...
2. **Replace setup code** with fixture usage
3. **Run tests** to verify behavior
4. **Clean up** unused imports and patch decorators
...
2. **Use context factories for custom behavior** - When you need specific mock behavior
3. **Use bridge functions during transition** - For gradual migration
4. **Keep one pattern per file** - Don't mix old and new patterns in same file
5. **Test immediately after migration** - Don't batch migrations without testing
