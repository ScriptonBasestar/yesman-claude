...
Enable browser-based access to Claude sessions through WebSocket protocol, allowing users to interact with tmux sessions directly from the Tauri dashboard or any web browser.
