...
class TestSecurityValidator:
    ...
    @pytest.mark.security
    def test_bandit_scan_success(self, validator):
    ...
    @pytest.mark.security
    def test_dependency_vulnerability_check(self, validator):
        """Test dependency vulnerability checking."""
        result = validator.check_dependencies("/test/requirements.txt")
        assert result is True

    @pytest.mark.security
    def test_secrets_detection(self, validator):
    ...
    @pytest.mark.security
    def test_validate_project_structure(self, validator):
        """Test project structure validation."""
        result = validator.validate_project_structure(".")
        assert result is True

    @pytest.mark.security
    def test_severity_threshold_filtering(self, validator):
    ...
    @pytest.mark.security
    def test_security_metrics_collection(self, validator):
    ...
    @pytest.mark.security
    def test_security_alert_generation(self, validator):
...
class TestPerformanceMonitoring:
    ...
    @pytest.mark.performance
    def test_event_bus_monitoring(self):
