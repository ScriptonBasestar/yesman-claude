...
from libs.core.prompt_detector import ClaudePromptDetector, PromptInfo, PromptType
...
class TestClaudePromptDetector(unittest.TestCase):
    ...
    def test_detect_numbered_selection_prompt_should_return_correct_type(self):
        """Test that numbered selection prompts are correctly detected and return PromptType.NUMBERED_SELECTION"""
        content = """
...
"""
    ...
    def test_detect_binary_choice_yn_prompt_should_return_binary_choice_type(self):
        """Test that y/n binary choice prompts are correctly detected and return PromptType.BINARY_CHOICE"""
    ...
    def test_detect_true_false_prompt_should_return_true_false_type(self):
        """Test that true/false prompts are correctly detected and return PromptType.TRUE_FALSE"""
