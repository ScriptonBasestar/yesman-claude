...
from libs.dashboard.renderers.registry import RendererRegistry, registry
...
class TestEnums:
    ...
    def test_widget_type_enum(self):
        ...
        expected_widgets = [
            'SESSION_BROWSER', 'HEALTH_METER', 'ACTIVITY_HEATMAP',
            'PROJECT_HEALTH', 'GIT_ACTIVITY', 'PROGRESS_TRACKER',
            'SESSION_PROGRESS', 'LOG_VIEWER', 'METRIC_CARD',
            'STATUS_INDICATOR', 'CHART', 'TABLE', 'GRID', 'LIST', 'TREE'
        ]
