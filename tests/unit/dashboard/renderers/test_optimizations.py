...
from libs.dashboard.renderers.optimizations import (
    ...
    global_profiler, profile_render, get_cache_stats, clear_all_caches,
...
from libs.dashboard.renderers.widget_models import MetricCardData, SessionData, SessionStatus
...
class TestOptimizationIntegration:
    ...
    def test_batch_vs_individual_rendering(self):
        ...
        metrics = [
            MetricCardData(title=f"Metric {i}", value=i * 10)
            for i in range(5)
        ]
