...
class SessionSelector:
    ...
    def _create_display(self, search_term: str = "") -> Table:
        ...
        table = Table(title="🖥️  Select a tmux session", show_header=True, header_style="bold magenta", 
        ...
        if search_term:
            filtered_sessions = [
                ...
                if search_term.lower() in s['project'].lower() or 
                   search_term.lower() in s['session'].lower()
            ]
