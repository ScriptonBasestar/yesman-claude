...
class MonitoringDashboardSystem:
    ...
    def __init__(self):
        ...
        self._quality_gates_task: Optional[asyncio.Task] = None
    ...
    def _setup_config_handlers(self) -> None:
        ...
        self.config_manager.register_change_callback(
            ...
            self._handle_alert_change
        )
        
        # Handle dashboard changes
        self.config_manager.register_change_callback(
            ConfigSection.DASHBOARD,
            self._handle_dashboard_change
        )
        
        # Handle baseline changes
        self.config_manager.register_change_callback(
            ConfigSection.BASELINES,
        ...
        while self._is_running:
            try:
                ...
                if results.get("blocking_failures"):
                    self.logger.error(
                        "Quality gates failed: %d blocking failures",
    ...
    async def get_system_status(self) -> dict:
        ...
        status = {
            ...
            "quality_gates": {
                ...
                "regression_threshold": self.config_manager.config.quality_gates.get(
...
# Singleton instance
_monitoring_system: Optional[MonitoringDashboardSystem] = None
