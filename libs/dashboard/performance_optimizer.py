...
class OptimizationStrategy:
    ...
    def should_optimize(self, metrics: PerformanceMetrics) -> bool:
        ...
        return (
            metrics.cpu_usage > self.cpu_threshold or
...
class AsyncPerformanceOptimizer:
            ...
            try:
                async with self.semaphore:
                    ...
                    metrics = await loop.run_in_executor(
                        None, self.optimizer._collect_metrics
                    )
    ...
    async def _apply_async_optimization(self, level: OptimizationLevel) -> None:
        ...
        await loop.run_in_executor(
            None, self.optimizer._apply_optimization, level
        )
    ...
    async def get_performance_report(self) -> Dict[str, Any]:
        ...
        return await loop.run_in_executor(
            None, self.optimizer.get_performance_report
        )
...
def reset_performance_optimizer() -> None:
    ...
    global _global_optimizer
    if _global_optimizer and _global_optimizer.monitoring:
