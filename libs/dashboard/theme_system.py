...
class ThemeManager:
    ...
    Manages themes across all dashboard interfaces with consistent
    styling, auto-detection, and user preferences.
    """
    ...
    def __init__(self, config_dir: Optional[Path] = None):
        ...
        if config_dir is None:
            config_dir = Path.home() / ".yesman" / "themes"
    ...
    def export_textual_css(self, theme: Optional[Theme] = None) -> str:
        ...
        css_lines = [
            ...
            "",
            "Button:hover {",
            f"    background: {colors.primary_dark};",
            "}",
            "",
            "Input {",
            f"    background: {colors.surface};",
            f"    color: {colors.text};",
            f"    border: solid {colors.border};",
            "}",
            "",
            "Panel {",
