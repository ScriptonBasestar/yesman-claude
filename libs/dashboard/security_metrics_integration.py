...
class SecurityMetricsIntegration:
    ...
    def __init__(
        self,
        monitoring_dashboard: MonitoringDashboardIntegration | None = None,
    ...
    async def _publish_correlation_summary(
        ...
        summary_event = Event(
            ...
            data={
                ...
                "high_impact_components": [c["component"] for c in correlations if c["impact"] > 20],
...
# Singleton instance
_security_metrics: SecurityMetricsIntegration | None = None
...
def get_security_metrics_integration(
    ...
    """
    global _security_metrics  # noqa: PLW0603
