...
class WebRenderer(BaseRenderer):
    ...
    def _render_session_table(self, sessions: List[SessionData], options: Dict[str, Any], component_id: str) -> str:
        ...
        for session in sessions:
            ...
            html_parts.extend([
                ...
                f'<td class="px-6 py-4 whitespace-nowrap"><span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {status_class}">{session.status.value.upper()}</span></td>',
        ...
        # Add JavaScript data
        html_parts.append(self._embed_widget_data(component_id, {
    ...
    def _render_session_cards(self, sessions: List[SessionData], options: Dict[str, Any], component_id: str) -> str:
        ...
        for session in sessions:
            ...
            html_parts.extend([
                ...
                f'<dl><dt class="text-sm font-medium text-gray-500 truncate">Session</dt>',
    ...
    def _render_metric_card(self, data: MetricCardData, options: Dict[str, Any], component_id: str) -> str:
        ...
        if data.trend is not None:
            if data.trend > 0:
                ...
                trend_html = f'<span class="text-gray-600">➡️ 0</span>'
    ...
    def _render_generic_widget(self, widget_type: WidgetType, data: Any, options: Dict[str, Any], component_id: str) -> str:
        ...
        html_parts = [
            ...
            f'<p class="text-sm text-yellow-700 mt-2">Widget renderer not implemented</p>',
    ...
    def _render_error_widget(self, error_message: str, component_id: str) -> str:
        """Render error widget"""
        return f'''
    ...
    def _get_health_color_class(self, health_level: HealthLevel) -> str:
