...
run_command(
    ["python", "-m", "ruff", "format", "libs", "commands", "api", "tests"],
...
run_command(
    ["python", "-m", "ruff", "check", "--fix", "libs", "commands", "api", "tests",
     "--exclude", "migrations", "--exclude", "node_modules"],
